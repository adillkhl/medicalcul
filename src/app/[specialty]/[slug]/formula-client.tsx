...
import { Calculator, ArrowLeft, FileText, AlertCircle } from 'lucide-react'
...
export default function FormulaClient({ specialty, slug }: { specialty: string; slug: string }) {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
      ...
      >
        <ArrowLeft className="size-3" /> {specialty}
      </Link>
        ...
        {result && (
          <div className="mt-5 space-y-3">
            ...
            <div className="rounded-lg bg-zinc-50 px-4 py-3">
              ...
              <div className="text-sm leading-relaxed text-zinc-700 [&_strong]:font-semibold"
                dangerouslySetInnerHTML={{ __html: formula.interpretation }}
              />
            </div>
            ...
            {formula.clinicalCommentary && (
              <div className="rounded-lg border border-amber-100 bg-amber-50 px-4 py-3">
                ...
                <div className="text-sm leading-relaxed text-amber-800"
                  dangerouslySetInnerHTML={{ __html: formula.clinicalCommentary }}
                />
              </div>
            )}
