...
const ballard: FormulaDefinition = {
  ...
  inputs: [
    ...
    {id:`angle_poplite`,type:`radio`,label:`Angle poplité`,options:[{value:-1,label:`> 160°`},{value:0,label:`140°`},{value:1,label:`120°`},{value:2,label:`100°`},{value:3,label:`80°`},{value:4,label:`60°`},{value:5,label:`≤ 50°`}]},
    {id:`signe_foulard`,type:`radio`,label:`Signe du foulard`,options:[{value:-1,label:`< 24 sem: coude dépasse ligne médiane`},{value:0,label:`26 sem: coude à la ligne médiane`},{value:1,label:`28 sem: coude vers sternum`},{value:2,label:`30 sem: coude proche sternum`},{value:3,label:`32 sem: coude avant ligne médiane`},{value:4,label:`34 sem: coude net avant médiane`},{value:5,label:`≥ 36 sem: coude bien avant médiane`}]},
    ...
    {id:`peau`,type:`radio`,label:`Peau (externe)`,options:[{value:-1,label:`< 26 sem: gélatineuse, rouge`},{value:0,label:`26-27 sem: fine, lisse`},{value:1,label:`28-29 sem: fine, desquamation`},{value:2,label:`30-31 sem: rugueuse`},{value:3,label:`32-33 sem: épaisse`},{value:4,label:`34-36 sem: craquelée`},{value:5,label:`≥ 37 sem: parcheminée`}]},
    ...
    {id:`mamelon`,type:`radio`,label:`Mamelon`,options:[{value:-1,label:`< 26 sem: non visible`},{value:0,label:`26-27 sem: aréole visible`},{value:1,label:`28-29 sem: aréole bombée`},{value:2,label:`30-31 sem: mamelon visible`},{value:3,label:`32-33 sem: mamelon formé`},{value:4,label:`≥ 34 sem: mamelon 3-5 mm`},{value:5,label:`≥ 37 sem: mamelon 5-10 mm`}]},
    {id:`oeil`,type:`radio`,label:`Œil / Oreille`,options:[{value:-1,label:`< 26 sem: paupières fusionnées`},{value:0,label:`26-27 sem: œil ouvert, pavillon plat`},{value:1,label:`28-29 sem: pavillon incurvé`},{value:2,label:`30-31 sem: pavillon formé, cartilage`},{value:3,label:`32-33 sem: cartilage ferme`},{value:4,label:`≥ 34 sem: cartilage épais`},{value:5,label:`≥ 37 sem: cartilage très ferme`}]},
    {id:`genital`,type:`radio`,label:`Génital (garçon)`,options:[{value:-1,label:`< 26 sem: testicules non descendus`},{value:0,label:`26-27 sem: testicules haut scrotum`},{value:1,label:`28-29 sem: testicules mi-scrotum`},{value:2,label:`30-31 sem: testicules bas scrotum`},{value:3,label:`32-33 sem: scrotum plissé`},{value:4,label:`≥ 34 sem: testicules en place, plis profonds`},{value:5,label:`≥ 36 sem: testicules pendants`}]},
  ],
  calculate: (values) => {
