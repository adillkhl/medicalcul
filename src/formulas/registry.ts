...
import cirs from './cardiologie/cirs'
import cornell from './cardiologie/cornell'
import csrs from './cardiologie/csrs'
import french from './cardiologie/french'
import girerdobsth from './cardiologie/girerdobsth'
import safe_marche_ryan from './cardiologie/safe_marche_ryan'
import shockidx from './cardiologie/shockidx'
import sris from './cardiologie/sris'
import globe from './divers/globe'
import haps from './divers/haps'
import hypotherclass from './divers/hypotherclass'
import hypotherm_vitals from './divers/hypotherm_vitals'
import ptikhellaf from './divers/ptikhellaf'
import pts_score from './divers/pts_score'
import rendplq from './divers/rendplq'
import vittel from './divers/vittel'
import wast from './divers/wast'
import blamey from './gastroenterologie/blamey'
import brest from './gastroenterologie/brest'
import harveybradshaw from './gastroenterologie/harveybradshaw'
import imrie from './gastroenterologie/imrie'
import lichtiger from './gastroenterologie/lichtiger'
import lille from './gastroenterologie/lille'
import maddrey from './gastroenterologie/maddrey'
import truelovewitts from './gastroenterologie/truelovewitts'
import adlkatz from './geriatrie/adlkatz'
import aggir_calc from './geriatrie/aggir_calc'
import aggir_gir from './geriatrie/aggir_gir'
import algoplus from './geriatrie/algoplus'
import doloplus from './geriatrie/doloplus'
import elift from './geriatrie/elift'
import epices from './geriatrie/epices'
import gds15 from './geriatrie/gds15'
import iadllawton from './geriatrie/iadllawton'
import abc_transfu from './hematologie/abc_transfu'
import annarbor from './hematologie/annarbor'
import binet from './hematologie/binet'
import ecpa_pnc from './hematologie/ecpa-pnc'
import hlh2004 from './hematologie/hlh2004'
import isth_civd from './hematologie/isth_civd'
import voltransfucgr from './hematologie/voltransfucgr'
import omssida from './infectiologie/omssida'
import deficitfer from './medecine_interne/deficitfer'
import padoue from './medecine_interne/padoue'
import ruffierdickson from './medical_sport/ruffierdickson'
import ckdepi2021 from './nephrologie/ckdepi2021'
import fractexcret_au from './nephrologie/fractexcret_au'
import fractexcret_uree from './nephrologie/fractexcret_uree'
import idx_excretion_uree from './nephrologie/idx_excretion_uree'
import ira_indices from './nephrologie/ira_indices'
import irastades from './nephrologie/irastades'
import irstades from './nephrologie/irstades'
import kfre from './nephrologie/kfre'
import osmourine from './nephrologie/osmourine'
import ratioprotucreatu from './nephrologie/ratioprotucreatu'
import uti_d from './nephrologie/uti_d'
import uvsurp from './nephrologie/uvsurp'
import chumlea from './nutrition/chumlea'
import depenergie from './nutrition/depenergie'
import mgap from './nutrition/mgap'
import ringmessmer from './nutrition/ringmessmer'
import vo2maxth from './nutrition/vo2maxth'
import tripcast from './orthopedie/tripcast'
import eva_enfant from './pediatrie/eva_enfant'
import glasgowped2 from './pediatrie/glasgowped2'
import glasgowped3 from './pediatrie/glasgowped3'
import mercuriali from './pediatrie/mercuriali'
import presev from './pediatrie/presev'
import schwartz from './pediatrie/schwartz'
import gold2017 from './pneumologie/gold2017'
import goldbpco from './pneumologie/goldbpco'
import fssfatigue from './psychiatrie/fssfatigue'
import hscore from './psychiatrie/hscore'
import pasi from './psychiatrie/pasi'
import cavo2 from './reanimation/cavo2'
import diurese_horaire from './reanimation/diurese_horaire'
import pertsgaccept from './reanimation/pertsgaccept'
import ccmu from './urgence/ccmu'
import gemsa from './urgence/gemsa'
import issrtstriss from './urgence/issrtstriss'
import ottawacephalee from './urgence/ottawacephalee'
import ptscore from './urgence/ptscore'
